...
declare namespace mojs {
  ...
  class Tweenable extends Module {
     ...
     */
    play(shift?: number): any

    /**
     *  Starts playback in backward direction.
     *  @param shift {Number} Start progress shift in milliseconds.
     */
    playBackward(shift?: number): any
  ...
  interface ShapeOptions {
     ...
     *  @param isYoyo {Boolean} If progress inside `yoyo` flip period.
     */
    onFirstUpdate?: (isForward: boolean, isYoyo: boolean) => any
     ...
     *  @param isYoyo {Boolean} If in `yoyo` period.
     */
    onUpdate?: (ep: number, p: number, isForward: boolean, isYoyo: boolean) => any
     ...
     *  @param isYoyo {Boolean} If progress inside `yoyo` flip period.
     */
    onRepeatComplete?: (isForward: boolean, isYoyo: boolean) => any
     ...
     *  @param isYoyo {Boolean} If progress inside `yoyo` flip period.
     */
    onComplete?: (isForward: boolean, isYoyo: boolean) => any
  ...
  class easing {
    static bezier(...args: any[]): any
    static mix(...args: any[]): any
    static path(path: string): any
    static approximate(slowEasing: any): any
    static inverse(): any
  ...
  interface HTMLOptions {
    ...
    background?: string | { [delta: string]: string }
  ...
  interface TweenOptions {
     ...
     */
    onRefresh?: (isBefore: boolean) => any
  ...
  class Timeline extends Tween {
     ...
     *  @returns {Object} Self.
     */
    add(tween: Object | any, ...args: any[]): any
     ...
     *  @returns {Object} Self.
     */
    append(tween: Object | any[]): any

    /**
     *  API method to stop the Tween.
     *  @param   {Number} Progress [0..1] to set when stopped.
     */
    stop(progress: number): any
  ...
  function stagger(shape: Shape): any

  interface MojsStatic {
    CustomShape: ObjectConstructor
    addShape(name: string, shape: any): any
    Timeline(): void
